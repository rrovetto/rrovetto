I specialize in three disciplines: What I call Abstraction Modeling, Interdisciplinary Space Research, and Maritime Operations and Safety. My GitHub pages are about the first, its application to the other, while also offering a set of other projects that are open to investors and partners. 

Available worldwide for [hire](https://tinyurl.com/yas7trzy) to do conceptual modeling, formal [ontology](https://ontologforum.com/index.php/RobertRovetto), basic model-based systems engineering (MBSE), semantic data modeling, conceptual analysis, terminology, metadata (development, refinement, harmonization), concept/visual/graph diagram development, as well as writing (resarch, academic, reports, grants, proposals), philosophy, and ethics. 
