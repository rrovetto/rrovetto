:smiley: - I'm available for hire to do formal ontology, conceptual data modeling (e.g., in MBSE), semantic modeling, concept analysis, philosophy, terminology, and spaceflight research. I'm actively searching globally for a PhD study opportunity. I have [articles](https://orcid.org/0000-0003-3835-7817), and serve in (inter)national committees on ontology, semantic tech., aerospace, maritime safety, and standards orgs. I can help **clarify complex concepts** in formal, philosophical and computational ontology, and semantic/knowledge modeling, as well as help you understand ethical aspects thereof. I can help **create or improve terminologies, ontologies, and metadata**.
